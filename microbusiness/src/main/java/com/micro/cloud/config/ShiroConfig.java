...
import com.micro.cloud.common.security.shiro.filter.UserAccessFilter;
...
public class ShiroConfig {
	...
	public SecurityManager securityManager(CacheManager shiroSpringCacheManager,
	...
	public ShiroFilterFactoryBean shiroFilter(
		...
		hashMap.put("/**", "user,userAccess,perms,roles,forceLogout");
