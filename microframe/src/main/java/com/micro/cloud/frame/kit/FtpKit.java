...
public class FtpKit {
	...
	public FtpKit(String hostname, String username, String password) {
		this.hostname = hostname;
		this.username = username;
		this.password = password;
	}

	public FtpKit(String hostname, Integer port, String username,
			String password) {
		this.hostname = hostname;
		this.port = port;
		this.username = username;
	...
	private void initFtpClient() {
		...
		try {
			System.out.println(
					"connecting...ftp服务器:" + this.hostname + ":" + this.port);
		...
		if (!directory.equalsIgnoreCase("/")
			...
			while (true) {
				String subDirectory = new String(
						remote.substring(start, end).getBytes("GBK"),
						"iso-8859-1");
	...
	public static void main(String[] args) {
		FtpKit ftp = new FtpKit("101.132.156.241", "ftpxyyh", "ewidexyyh!@#");
		ftp.uploadFile("/upload", "20180821_m20181231000000448.txt",
				"D://20180821_m20181231000000448.txt");
		ftp.downloadFile("/upload", "20180821_m20181231000000448.txt", "F://");
		// ftp.deleteFile("/upload", "1234.txt");
